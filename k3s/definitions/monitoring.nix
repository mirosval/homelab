  ...
  applications.monitoring = {
    ...
    helm.releases.k8s-monitoring = {
      chart = lib.helm.downloadHelmChart {
        ...
        version = "3.8.5";
        chartHash = "sha256-KZ01OjbpLkmiDMBnsLDMbUPvgBi1/tGzvdoXNZxPpHA=";
      };
    ...
    helm.releases.loki = {
      chart = lib.helm.downloadHelmChart {
        ...
        chart = "loki";
        version = "7.0.0";
        chartHash = "sha256-7/sn+8D370BJV0F3BxgFiaUHBIrPXPO+zzzB0USxxWc=";
      };
    ...
    helm.releases.prometheus = {
      chart = lib.helm.downloadHelmChart {
        ...
        version = "82.15.0";
        chartHash = "sha256-sMEljyv9khmkMZPo/fng6RgfJiarIdyEcZalfA1tYg8=";
      };
